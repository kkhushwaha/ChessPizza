...
// document.getElementById(divid).style.backgroundColor='#AAA';
	  ...
	  if((colorOfEntity=='W' && entity=='ROOK') || (colorOfEntity=='B' && entity=='ROOK') )
	  moveBROOK();
	  
	   if((colorOfEntity=='W' && entity=='KNIGHT') || (colorOfEntity=='B' && entity=='KNIGHT'))
	  moveWKNIGHT();
	  
	  if((colorOfEntity=='W' && entity=='QUEEN') || (colorOfEntity=='B' && entity=='QUEEN'))
	  moveWQUEEN();
	  
	  if((colorOfEntity=='W' && entity=='KING') || (colorOfEntity=='B' && entity=='KING'))
	  moveWKING();
	
	    if((colorOfEntity=='W' && entity=='BISHOP') || (colorOfEntity=='B' && entity=='BISHOP'))
	  moveWBISHOP();
...
/*if(colorOfEntity!=colorOfEntity2)
